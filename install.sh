...
H_VOL_BASE=/opt/${NAME}   # host directory path for mounting key guest directories 
H_AMQ_PORT=5672 	  # Host AMQ connection port
H_MAN_PORT=15672   	  # Host Management Console port
#
## --- KEEP AT 1 FOR NOW --- 
#CLUSTER_SIZE=1
## --- ***************** ---
...
#
## Guest Directories
G_VOL_ETC=/opt/${NAME}/rabbitmq
G_VOL_LIB=/opt/${NAME}/var/lib/rabbitmq
#
## Set Master 
MA=${NAME}
MA_LONG=$MA.${DOMAIN}
